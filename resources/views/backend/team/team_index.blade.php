                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="multilevel-btn" rowspan="1" colspan="1"
                                    ...
                                    aria-label="Theme Name: activate to sort column ascending">Nom de l'équipe équipe
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="multilevel-btn" rowspan="1" colspan="1"
                                    style="width: 272.617px;"
                                    aria-label="Theme Name: activate to sort column ascending">Photo de l'équipe
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="multilevel-btn" rowspan="1" colspan="1"
                                    style="width: 272.617px;"
                                    aria-label="Theme Name: activate to sort column ascending">Type d'équipe
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="multilevel-btn" rowspan="1" colspan="1"
                        ...
                        <tbody>
                            @foreach($teams as $key => $value)
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/'.$value->team_pics) }}" alt="Image de l'équipe" width="100">
                                    </td>
