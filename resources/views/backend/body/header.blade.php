...
<div class="logo-wrapper d-flex align-items-center col-auto">
    ...
    <a class="close-btn toggle-sidebar" href="javascript:void(0)">
        <svg class="svg-color">
                <g fill="none" fill-rule="evenodd" clip-rule="evenodd" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M3 6.5C3 3.87479 3.02811 3 6.5 3C9.97189 3 10 3.87479 10 6.5C10 9.12521 10.0111 10 6.5 10C2.98893 10 3 9.12521 3 6.5Z"></path>
                    <path opacity="0.5" d="M14 6.5C14 3.87479 14.0281 3 17.5 3C20.9719 3 21 3.87479 21 6.5C21 9.12521 21.0111 10 17.5 10C13.9889 10 14 9.12521 14 6.5Z"></path>
                    <path d="M3 17.5C3 14.8748 3.02811 14 6.5 14C9.97189 14 10 14.8748 10 17.5C10 20.1252 10.0111 21 6.5 21C2.98893 21 3 20.1252 3 17.5Z"></path>
                    <path d="M14 17.5C14 14.8748 14.0281 14 17.5 14C20.9719 14 21 14.8748 21 17.5C21 20.1252 21.0111 21 17.5 21C13.9889 21 14 20.1252 14 17.5Z"></path>
                </g>
        </svg>
    </a>
</div>
    ...
    <div class="form-group-header d-lg-block d-none">
      <div class="Typeahead Typeahead--twitterUsers">
        <div class="u-posRelative d-flex align-items-center"> 
          <input class="demo-input py-0 Typeahead-input form-control-plaintext w-100" type="text" placeholder="Type to Search..." name="q" title=""/><i class="fas fa-search"></i>
        </div>
      </div>
    </div>
  </div>
  <div class="nav-right">
    <ul class="header-right"> 
      ...
      <li class="custom-dropdown"><a href="javascript:void(0)">
        ...
        </a><span class="badge rounded-pill badge-primary">2</span>
        <div class="custom-menu cart-dropdown py-0 overflow-hidden">
          <h3 class="title dropdown-title">Cart</h3>
          <ul class="pb-0">
            <li>
              <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('storage/backend/assets2/images/dashboard-2/1.png') }}" alt=""/>
            ...
            <li>
              <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('storage/backend/assets2/images/dashboard-2/2.png') }}" alt=""/>
      ...
      <li class="custom-dropdown"><a href="javascript:void(0)">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-notification">
          <path d="M18 8a6 6 0 00-12 0c0 7-3 8-3 8h18s-3-1-3-8"></path>
     ...
     <!-- <li class="custom-dropdown"><a href="javascript:void(0)">
      ...
      <li class="profile-nav custom-dropdown">
        <div class="user-wrap">
          <div class="user-img"><img src="{{ asset('storage/backend/assets2/images/profile.png') }}" alt="user"/></div>
          <div class="user-content">
            <h6>{{ $profil->first_name }}</h6>
